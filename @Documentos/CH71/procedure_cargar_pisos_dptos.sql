...
BEGIN
    ...
    WHILE i <= cantidad_edificios DO
          ...
          SELECT cantidad_departamentos, cantidad_pisos-1 INTO cantidad_deptos,  cant_pisos FROM edificios WHERE id_edificio = i;
                ...
                WHILE x <= cant_pisos + 1 DO
					...
					IF x = PB THEN
						...
						WHILE y <= PISOS2D DO /* INGRESO LOS DEPARTAMENTOS DE PB */
							...
							CALL AgregarDepartamento(APTO2DSA,y,i,ULTIMO_ID_INGERSADO);
                        	SET y = y + 1;
					...
					ELSE
						...
						WHILE y <= PISOS8D DO 
                            ...
                            IF y = 1 THEN
								CALL AgregarDepartamento(APTO2DSA,id_dpto,i,ULTIMO_ID_INGERSADO);
                            ELSEIF y = 2 THEN
								CALL AgregarDepartamento(APTO2DSA,id_dpto,i,ULTIMO_ID_INGERSADO);
							ELSEIF y = 3 THEN
								CALL AgregarDepartamento(APTO1D,id_dpto,i,ULTIMO_ID_INGERSADO);
                            ELSEIF y = 4 THEN
								CALL AgregarDepartamento(APTO1D,id_dpto,i,ULTIMO_ID_INGERSADO);
							ELSEIF y = 5 THEN
								CALL AgregarDepartamento(APTO1D,id_dpto,i,ULTIMO_ID_INGERSADO);
				...
				WHILE x <= cant_pisos DO
					...
					IF x = PB THEN
                        ...
                        IF i = 8 OR i = 26 OR i = 32 OR i = 36 THEN
							SET y = 1;
							WHILE y <= PISOS2D DO /* INGRESO LOS DEPARTAMENTOS DE PB */
								CALL AgregarDepartamento(APTO4D,y,i,ULTIMO_ID_INGERSADO);
								SET y = y + 1;
							END WHILE;
                        ...
                        ELSE
							...
							WHILE y <= PISOS2D DO /* INGRESO LOS DEPARTAMENTOS DE PB */
							   IF y = 1 THEN
									CALL AgregarDepartamento(APTO3D,y,i,ULTIMO_ID_INGERSADO);
							    ELSE
									CALL AgregarDepartamento(APTO2D,y,i,ULTIMO_ID_INGERSADO);
                                END IF;
					...
					ELSE
						...
						WHILE y <= PISOS4D DO 
                            ...
                            IF i = 8 OR i = 26 OR i = 32 OR i = 36 THEN
								CALL AgregarDepartamento(APTO4D,id_dpto,i,ULTIMO_ID_INGERSADO);
                            ELSE
                             	 IF y = 1  THEN
									CALL AgregarDepartamento(APTO2D,id_dpto,i,ULTIMO_ID_INGERSADO);
								ELSEIF y = 2 THEN
									CALL AgregarDepartamento(APTO3D,id_dpto,i,ULTIMO_ID_INGERSADO);
								ELSEIF y = 3 THEN
									CALL AgregarDepartamento(APTO3D,id_dpto,i,ULTIMO_ID_INGERSADO);
								ELSEIF y = 4 THEN
									CALL AgregarDepartamento(APTO2D,id_dpto,i,ULTIMO_ID_INGERSADO);
...
DROP procedure IF EXISTS `AgregarDepartamento`;
DELIMITER $$
USE `sigecs`$$
