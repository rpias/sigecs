...
<div class="contenedor">
    <div class="via-cliente">
        ...
        <div class="contenedor-leyenda">
            ...
            echo '<p>RECIBÍ______DE:_'.'<span class="leyenda-agregada">'.strtoupper($recibo[0]->titular).'</span>'.$lineasPrimerRenglon
            ...
            @endphp
            <p>POR CONCEPTO DE GASTOS COMUNES, CONVENIOS Y/O FONDOS DE RESERVA</p>
