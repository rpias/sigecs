...
Route::get('unidades/{id}/saldo_inicial', 'UnidadController@saldoInicial')->middleware('auth');
Route::get('ultimopago', 'CobranzaController@ultimoPagoPorUnidad')->middleware('auth');
Route::get('unidad/{id}/convenios', 'ConveniosController@conveniosPorUnidad')->middleware('auth');
Route::get('obtener_nro_recibo/{serie}/serie', 'CobranzaController@getNumeroReciboSerie')->middleware('auth');
...
Route::post('guardar_saldo_inicial', 'UnidadController@guardarSaldoInicial')->middleware('auth');
...
Route::post('crear_convenio', 'ConveniosController@crear_convenio')->middleware('auth');
Route::get('pdf_convenio', 'ConveniosController@pdf_convenio')->middleware('auth');

// FACTURAS
//Route::resource('facturas/index', 'FacturasController')->middleware('auth');
Route::get('facturas/formas_pago', 'FacturasController@formasPago')->middleware('auth');
...
Route::get('unidad/{id_unidad}/deudaUnidad', 'ConveniosController@deudaUnidad')->middleware('auth');
